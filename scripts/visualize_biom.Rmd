...
params:
  ...
  merged_tax_tab_file: "/localdisk/home/kpin/downstream/metagenomics/2022-5-10_test_pb16S-nf_ATCC_MSA1003/results_macrogen_with_lima_in_nf_q30/results/merged_freq_tax.tsv"
  ...
  dada2_qc: "/localdisk/home/kpin/downstream/metagenomics/2022-5-10_test_pb16S-nf_ATCC_MSA1003/results_macrogen_with_lima_in_nf_q30/results/dada2_qc.tsv" 
  reads_qc: "/localdisk/home/kpin/github/test/work/75/a1840a87649fd88826b0764f8ec8ab/all_samples_seqkit.readstats.tsv"
  summarised_reads_qc: "/localdisk/home/kpin/downstream/metagenomics/2022-5-10_test_pb16S-nf_ATCC_MSA1003/work/f3/4ad0c64dc9a220a475530e41e08565/seqkit.summarised_stats.group_by_samples.tsv"
  lima_qc: "/localdisk/home/kpin/github/test/work/75/a1840a87649fd88826b0764f8ec8ab/all_samples_lima_stats.tsv"
---
...
* Total number of reads after quality filtering: `r sum(all_read_count$input_reads)` (`r paste0(round(sum(all_read_count$input_reads)/nrow(reads_qc), 2)*100, "%")`)
* Total number of reads after primers trimming (DADA2 input): `r sum(all_read_count$demuxed_reads)` (`r round(sum(all_read_count$demuxed_reads)/sum(all_read_count$input_reads), 2)*100`%)
