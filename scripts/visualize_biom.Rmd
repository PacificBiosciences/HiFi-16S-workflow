...
### Bray-Curtis MDS plot (Based on VSEARCH taxonomy assignment)
...
### Top 50 ASVs with Naive Bayes Classifier
``` {r, echo=FALSE}
...
* Heatmap contains only species with >1% abundance in at least 2 samples.
``` {r, echo=FALSE}
# Display top 10
