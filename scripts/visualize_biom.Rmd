...
params:
  merged_tax_tab_file: "/localdisk/home/kpin/downstream/metagenomics/2022-5-10_test_pb16S-nf_ATCC_MSA1003/work/b3/09ca532e6aaca6ae51addf4391e574/best_tax_merged_freq_tax.tsv"
  metadata: "/localdisk/home/kpin/downstream/metagenomics/2022-5-10_test_pb16S-nf_ATCC_MSA1003/metadata.tsv"
  sample_file: "/localdisk/home/kpin/downstream/metagenomics/2022-5-10_test_pb16S-nf_ATCC_MSA1003/work/52/6bb3004d6824650c639555218dd51f/samplefile.txt"
  dada2_qc: "/localdisk/home/kpin/downstream/metagenomics/2022-5-10_test_pb16S-nf_ATCC_MSA1003/work/b3/3a1d7b2c27607602e5b49e8a1db95d/dada2_qc.tsv" 
  reads_qc: "/localdisk/home/kpin/downstream/metagenomics/2022-5-10_test_pb16S-nf_ATCC_MSA1003/work/22/8101664411a0afcc3e10fc57ae27d0/all_samples_seqkit.readstats.tsv"
  summarised_reads_qc: "/localdisk/home/kpin/downstream/metagenomics/2022-5-10_test_pb16S-nf_ATCC_MSA1003/work/22/8101664411a0afcc3e10fc57ae27d0/seqkit.summarised_stats.group_by_samples.tsv"
  cutadapt_qc: "none"
  vsearch_tax_tab_file: "/localdisk/home/kpin/downstream/metagenomics/2022-5-10_test_pb16S-nf_ATCC_MSA1003/work/de/f87cc27131d9f5996755e4b7c9ef6d/vsearch_merged_freq_tax.tsv"
  colorby: "condition"
  bray_mat: "/localdisk/home/kpin/downstream/metagenomics/2022-5-10_test_pb16S-nf_ATCC_MSA1003/work/04/0998ddd52091c984141b618756487b/core-metrics-diversity/bray_curtis_distance_matrix.tsv"
  wunifrac_mat: "/localdisk/home/kpin/downstream/metagenomics/2022-5-10_test_pb16S-nf_ATCC_MSA1003/work/04/0998ddd52091c984141b618756487b/core-metrics-diversity/weighted_unifrac_distance_matrix.tsv"
  unifrac_mat: "/localdisk/home/kpin/downstream/metagenomics/2022-5-10_test_pb16S-nf_ATCC_MSA1003/work/04/0998ddd52091c984141b618756487b/core-metrics-diversity/unweighted_unifrac_distance_matrix.tsv"
---
...
* Reads belong to ASV classified at Species level (Excluding metagenome/uncultured entries): `r round(sum(otu_table(phyloseq)[class_spec_uncultured$OTU,])/sum(otu_table(phyloseq)), 2)*100`%
...
* Reads belong to ASV classified at Genus level (Excluding metagenome/uncultured entries): `r round(sum(otu_table(phyloseq)[class_gen_uncultured$OTU,])/sum(otu_table(phyloseq)), 2)*100`%
...
* Reads belong to ASV classified at Species level (Excluding metagenome/uncultured entries): `r round(sum(otu_table(phyloseq)[class_spec_uncultured_vsearch$OTU,])/sum(otu_table(phyloseq)), 2)*100`%
...
* Reads belong to ASV classified at Genus level (Excluding metagenome/uncultured entries): `r round(sum(otu_table(phyloseq)[class_gen_uncultured_vsearch$OTU,])/sum(otu_table(phyloseq)), 2)*100`%
